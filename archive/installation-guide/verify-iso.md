...
> [!DANGER]\
> __You MUST pass this verification step before installation. Otherwise, you run a significant risk of bricking your computer and/or compromising its security.__
...
> [!INFO]\
> __Checksums__, or hashes, are the __digital fingerprint__ of a file. Any modification or inconsistency creates a different output than the expected hash.
...
3. __Copy and paste__ the expected hash into the __second value__ field. This is the string of text before whichever version you downloaded.
 ...
 > [!SUCCESS]\
 > If the output and expected hash are an exact match, the __integrity check was successful__.
